...
//   $desc = $_POST['desc'];
//   $tmp = $_FILES['img'] ['tmp_name']; // tmp_name is the path of the file in the temp memory
//   $filename = $_FILES['img'] ['name']; // the name of the file 
//   $user_id  = $_SESSION['user']['id']; // this is the user_id from the Session we created in the login

//   move_uploaded_file($tmp, "upload/" . $filename); // here we moved the file from the temp memory 
//                                                     //to the new directory 'upload with its name

//   //insert into db portfolio
              ...
              <form role="form" action="updateportfolio.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <textarea name="desc" class="form-control textarea"><?= $data['description']; ?></textarea>     
                    </div>
                  <img src="upload/<?= $data['img']; ?>" width="100px" alt="">
                  <div class="form-group">
